...
#Loading Data
dataFrame = pd.read_csv("C:/Users/HP/Desktop/traffic/traffic.csv")
...
# extract Hour, day, year and month from dateTime
...
df_J = dataFrame.pivot(columns="Junction", index="DateTime")
df_J.describe()
